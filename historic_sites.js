...
map.on('click', function onClick(e){
  $("#location").replaceText(e.feature.properties.Stop_No);
  $("#header").replaceText(e.feature.properties.name);
  $(".sidebar-description").replaceText(e.feature.properties.Desc);
});
